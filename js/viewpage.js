...
function Connect_DB() {
  ...
  dbSongkarnMemo = firebase.firestore().collection("APEMemo");
  dbSongkarnLike = firebase.firestore().collection("APELike");
  ShowView();
}
...
function ShowView() {
  ...
  snapshot.forEach(doc=> {
      ...
      str += '<div style="margin-top:50px;background-color: #f1f1f1;">';
      str += '<center><video id="video" style="max-width:450px;width:100%;margin:5px auto 5px auto;" controls="controls" autoplay>';
      str += '<source src="'+doc.data().SendImg+'" type="video/mp4"></video></center>';
      ...
      str1 += '<div class="chart-box" style="margin-top:10px;">';
