...
function ShowIMG() {
  ...
  if(UserSelect==0) {
    dbSongkarn.where('ClipStatus','==', 1)
    .orderBy('TimeStampDate','desc')
    .get().then((snapshot)=> {
      snapshot.forEach(doc=> {
        str += '<div class="box-APEshow" onclick="ClipVDO(\''+ doc.id +'\')">';
        if(doc.data().DisplayImg!="") {
          str += '<img src="'+doc.data().DisplayImg+'" class="imageVDO">';
        } else {
          str += '<img src="./img/clip-01.jpg" class="imageVDO">';
        }
        str += '<div class="middle"><div class="textVDO">'+doc.data().EmpName+'<br>'+doc.data().SendUnderRH+'</div></div></div>';
      });
      str += '</div>';
      $("#DisplayClip").html(str);
    });
  } else {
    var xRH = "RH"+UserSelect;
    dbSongkarn.where('SendUnderRH','==',xRH)
    .where('ClipStatus','==', 1)
    .orderBy('TimeStampDate','desc')
    .get().then((snapshot)=> {
      snapshot.forEach(doc=> {
...
function SelectMenu(x) {
  UserSelect = document.getElementById("ClickMenu").value;
  //alert(UserSelect);
/*
  UserSelect = x;
    $('#Menu0').removeClass('btn-t9');
    $('#Menu1').removeClass('btn-t9');
    $('#Menu2').removeClass('btn-t9');
    $('#Menu3').removeClass('btn-t9');
    $('#Menu4').removeClass('btn-t9');
    $('#Menu5').removeClass('btn-t9');
    $('#Menu6').removeClass('btn-t9');
    if(x==0) {
      $('#Menu0').removeClass('btn-t22');
      $('#Menu0').addClass('btn-t9');
      $('#Menu1').addClass('btn-t22');
      $('#Menu2').addClass('btn-t22');
      $('#Menu3').addClass('btn-t22');
      $('#Menu4').addClass('btn-t22');
      $('#Menu5').addClass('btn-t22');
      $('#Menu6').addClass('btn-t22');
    } else if(x==1) {
      $('#Menu1').removeClass('btn-t22');
      $('#Menu0').addClass('btn-t22');
      $('#Menu1').addClass('btn-t9');
      $('#Menu2').addClass('btn-t22');
      $('#Menu3').addClass('btn-t22');
      $('#Menu4').addClass('btn-t22');
      $('#Menu5').addClass('btn-t22');
      ...
      $('#Menu2').removeClass('btn-t22');
      $('#Menu0').addClass('btn-t22');
      $('#Menu1').addClass('btn-t22');
      $('#Menu2').addClass('btn-t9');
      $('#Menu3').addClass('btn-t22');
      $('#Menu4').addClass('btn-t22');
      $('#Menu5').addClass('btn-t22');
      $('#Menu6').addClass('btn-t22');
    } else if(x==3) {
      $('#Menu3').removeClass('btn-t22');
      $('#Menu0').addClass('btn-t22');
      $('#Menu1').addClass('btn-t22');
      $('#Menu2').addClass('btn-t22');
      $('#Menu3').addClass('btn-t9');
      $('#Menu4').addClass('btn-t22');
      $('#Menu5').addClass('btn-t22');
      $('#Menu6').addClass('btn-t22');
    } else if(x==4) {
      $('#Menu4').removeClass('btn-t22');
      $('#Menu0').addClass('btn-t22');
      $('#Menu1').addClass('btn-t22');
      $('#Menu2').addClass('btn-t22');
      $('#Menu3').addClass('btn-t22');
      $('#Menu4').addClass('btn-t9');
      $('#Menu5').addClass('btn-t22');
      $('#Menu6').addClass('btn-t22');
    } else if(x==5) {
      $('#Menu5').removeClass('btn-t22');
      $('#Menu0').addClass('btn-t22');
      $('#Menu1').addClass('btn-t22');
      $('#Menu2').addClass('btn-t22');
      $('#Menu3').addClass('btn-t22');
      $('#Menu4').addClass('btn-t22');
      $('#Menu5').addClass('btn-t9');
      $('#Menu6').addClass('btn-t22');
    } else if(x==6) {
      $('#Menu6').removeClass('btn-t22');
      $('#Menu0').addClass('btn-t22');
      $('#Menu1').addClass('btn-t22');
      $('#Menu2').addClass('btn-t22');
      $('#Menu3').addClass('btn-t22');
      $('#Menu4').addClass('btn-t22');
      $('#Menu5').addClass('btn-t22');
      $('#Menu6').addClass('btn-t9');
    }
*/
    ShowIMG();
    //$('#Menu6').addClass('btn-t9');
    //$('#Menu2').removeClass('btnCheck');
